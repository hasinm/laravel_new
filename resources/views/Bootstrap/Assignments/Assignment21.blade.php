            ...
            <div class="col-xs-12" style="margin-left:30px;">
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" id="inputUserEmail" placeholder="Email address" style="padding-right:1000px;"/>
                    </div>
                    <div class="form-group">
                        <label for="inputUserExperience"><b>Experience</b></label>
                        <input class="form-control" type="text" id="inputUserExperience" placeholder="Total Experience" style="padding-right:1000px;"/>
                    </div>
                    <div class="form-group">
